...
# generate_trend(8, 8, essentials.generate_chain1, '8-chain1_block-2_NNI-0.2_AS', u_param=8,
#                blocks=[[0, 1], [2, 3], [4, 5], [6, 7]], r_param=0.2)

# generate_trend(8, 8, essentials.generate_chain1, '8-chain1_NNI-0.2', u_param=8,
#                r_param=0.2)

lpfet.ACTIVE_SPACE_CALCULATION = False
generate_trend(8, 8, essentials.generate_chain1, '8-chain1_block-2_test2_hehe', u_param=8,
               blocks=[[0, 1], [2, 3], [4, 5], [6, 7]], r_param=0.2)

lpfet.ACTIVE_SPACE_CALCULATION = True
generate_trend(8, 8, essentials.generate_chain1, '8-chain1_NNI-0.2_AS_hehe', u_param=8, r_param=0.2,
               blocks=[[0], [1], [2], [3], [4], [5], [6], [7]])
# generate_trend(8, 8, essentials.generate_chain1, '8-chain1_NNI-0.2_AS', i_param=1, r_param=0.2)
