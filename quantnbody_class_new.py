...
class HamiltonianV2(qnb.Hamiltonian):
    ...
    def diagonalize_hamiltonian(self, full: bool = False, number_of_states: int = 3) -> None:
        super().diagonalize_hamiltonian(full, number_of_states)
        self.WFT_0 = self.eig_vectors[:, 0]
    ...
    def my_state(self, slater_determinant: List[int]) -> List[int]:
        ...
        """
        return qnb.tools.my_state(slater_determinant, self.nbody_basis)
    ...
    def build_s2_sz_splus_operator(self):
        ...
        s_2, s_plus, s_z :  matrix representation of the s_2, s_plus and s_z operators
                            in the many-body basis.
        """
        return qnb.tools.build_s2_sz_splus_operator(self.a_dagger_a)
    ...
    def calculate_1rdm_alpha(self, index=0):
        ...
        """
        self.one_rdm = qnb.tools.build_1rdm_alpha(self.eig_vectors[:, index], self.a_dagger_a)
        return self.one_rdm
    ...
    def calculate_1rdm_beta(self, index=0):
        ...
        """
        self.one_rdm = qnb.tools.build_1rdm_beta(self.eig_vectors[:, index], self.a_dagger_a)
        return self.one_rdm
    ...
    def calculate_1rdm_spin_free(self, index=0):
        ...
        """
        self.one_rdm = qnb.tools.build_1rdm_spin_free(self.eig_vectors[:, index], self.a_dagger_a)
        return self.one_rdm
    ...
    def build_2rdm_fh_on_site_repulsion(self, mask=None):
        ...
        """
        self.two_rdm = qnb.tools.build_2rdm_fh_on_site_repulsion(self.WFT_0, self.a_dagger_a, mask=mask)
        return self.two_rdm
    ...
    def build_2rdm_fh_dipolar_interactions(self, mask=None):
        ...
        """
        self.two_rdm = qnb.tools.build_2rdm_fh_dipolar_interactions(self.WFT_0, self.a_dagger_a, mask=mask)
        return self.two_rdm
    ...
    def build_2rdm_spin_free(self):
        ...
        """
        self.two_rdm = qnb.tools.build_2rdm_spin_free(self.WFT_0, self.a_dagger_a)
        return self.two_rdm
    ...
    def build_1rdm_and_2rdm_spin_free(self, index=0):
        ...
        """
        self.one_rdm, self.two_rdm = qnb.tools.build_1rdm_and_2rdm_spin_free(self.eig_vectors[:, index],
                                                                               self.a_dagger_a)
    ...
    def visualize_wft(self, index=0, wft: typing.Union[bool, List] = False, cutoff=0.005, atomic_orbitals=False):
       ...
       Parameters
        ...
        if isinstance(wft, bool) and not wft:
            ...
            wf = wft
        return qnb.tools.visualize_wft(wf, self.nbody_basis, cutoff, atomic_orbitals)
    ...
    def calculate_v_hxc(self, starting_approximation, silent=False,
        ...
        if not silent:
            print(f'successful convergence for true v_hxc; nfev={model.nfev}, nit={model.nit}, x={model.x},'
                  f' per_site_error={model.fun}')
        return v_hxc_2
