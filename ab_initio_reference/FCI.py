...
def calculate_reference(structure, basis='6-31G', use_hf_orbitals=False):
    ...
    # calculate symmetric orthogonal basis set:
    ...
    g2 = mints.ao_eri()
    g = np.einsum('pi, qj, rk, sl, ijkl', C, C, C, C, g2)
    ...
    from ab_initio_reference.helper_CI import Determinant, HamiltonianGenerator
